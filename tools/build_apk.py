#!/usr/bin/env python3
"""Build and v1-sign the offline EA888 Lab v1.2.0 Android APK.
...
def main() -> None:
    ...
    ap.add_argument('--output', type=Path, default=DIST / 'EA888-Lab-v1.2.0-Race-Weekend.apk')
    args = ap.parse_args()
    DIST.mkdir(parents=True, exist_ok=True)
    unsigned = DIST / 'EA888-Lab-v1.2.0-unsigned.apk'
